		...
		<div id="intro" class="preload darken" data-autoplay="5000"
			...
			<div class="intro-item"
				...
				<div class="caption">
					...
					<a class="button white transparent" href="portfolioExample.jsp">Example
						More</a>
				</div>
			</div>
			<div class="intro-item"
				...
				<div class="caption">
					...
					<a class="button white transparent" href="activityAdd.jsp">Let
						starting</a>
				</div>
			</div>
			<div class="intro-item"
				style="background-image: url(images/cover4.jpg);">
				<div class="caption">
					<h2>Create portfolio</h2>
					<p>Start designing your portfolio.</p>
					<a class="button white transparent" href="portfolioWork.jsp">Let
						starting</a>
				</div>
			</div>
		</div>
				...
				<div class="grid-items blog-section masonry-style preload">
					<article class="item column six">
						<a href="#">
							<figure>
								<img
									src="images/pictures/ab.jpg"
									alt="">
								<span class="blog-overlay"><i class="icon icon-doc"></i></span>
							</figure>
					...
					<article class="item column three">
						<a href="#">
							...
							<div class="blog-excerpt">
								<div class="blog-excerpt-inner">
									<h5 class="meta-post"></h5>
									<h2>โดยการรับนักเรียนเข้าศึกษาในมหาวิทยาลัยสงขลานครินทร์ ประจำปีการศึกษา 2561</h2>
									<p></p>
								</div>
								<!-- blog-excerpt -->
							</div> <!-- blog-excerpt-inner -->
...
-->
		<section class="row section text-light"
			style="background-color: #4FC1E9;">
			<div class="row-content buffer even clear-after">
				<div class="testimonial-slider centertxt" data-autoplay="5000"
					data-pagination="true" data-transition="fade"
					data-autoheight="false">
					<div class="quote">
						<p>"Don't be afraid to change. You may lose something good but
							you may gain something better."</p>
						<div class="author">(จงอย่ากลัวที่จะเปลี่ยนแปลง
							คุณอาจจะสูญเสียสิ่งที่ดีไปแต่คุณก็อาจจะได้รับในสิ่งที่ดีกว่ากลับมาแทน)</div>
					</div>
					<!-- quote -->
					<div class="quote">
						<p>"The most successful people in the world Have made many
							mistakes and experienced far more failure than the rest."</p>
						<div class="author">คนที่ประสบความสำเร็จมากที่สุดในโลกคือคนที่พบเจอความผิดพลาดและความล้มเหลวมามากกว่าคนอื่น&egrave;</div>
					</div>
					<!-- quote -->
					<div class="quote">
						<p>"You must lose your fear of being wrong in order to live a
							creative life."</p>
